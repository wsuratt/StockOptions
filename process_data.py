        ...
        try:
            ...
            if round(raw_data['UnderlyingPrice'][i]) == raw_data['Strike'][i] and raw_data['Type'][i] == 'call':
                ...
                if close_data.size:
                    ...
                    new_row = {'Symbol': raw_data['UnderlyingSymbol'][i], 'ExpirationDate': expiration_date, 'CallPremium': call_premium, 'PutPremium': put_premium, 'Volatility': percentage, 'BEUp': be_up_percent, 'BEDown': be_down_percent, 'Days': days_expiration, 'Output': output}
