...
:-------------------------:|:-------------------------:|:-------------------------:
![alt text](https://github.com/wsuratt/StockOptions/blob/main/results/model_loss.png)  |  ![alt text](https://github.com/wsuratt/StockOptions/blob/main/Results/model_acc.png)  |  ![alt text](https://github.com/wsuratt/LungImpedance/blob/main/Results/accuracy_results)
